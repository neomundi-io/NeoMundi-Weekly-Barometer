# NeoMundi Weekly Barometer #11 — Public Data Release

**Campaign:** `BAROMETER_11_2026-08-24_2026-08-30`  
**Observation period:** 2026-08-24 to 2026-08-30  
...
- Normal signal: 97.31% (4,671 observations)
- Semantic variation: 1.90% (91 observations)
- Factual alert: 0.29% (14 observations)
- Combined alert: 0.02% (1 observations)
- Incomplete measurement: 0.48% (23 observations)
...
- `comparability_report.json` — formal comparison with the preceding public release.

## Longitudinal comparability

**Status:** `COMPARABLE_WITH_RESERVATIONS`

- Previous campaign: `BAROMETER_10_2026-08-17_2026-08-23`
- Common longitudinal profiles: 12
- Current complete perimeter: 12
- Reservations: `CURRENT_CAMPAIGN_INCOMPLETE_MEASUREMENTS`

The detailed comparison is published in `comparability_report.json`.

This status documents the comparability of the protocol and public release
conditions. It does not validate metric performance, establish causality or
...
## Public Release 2.2.0 improvements
...
These improvements concern release integrity, traceability, consistency and longitudinal comparability.
