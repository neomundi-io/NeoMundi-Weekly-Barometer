...
**Campaign:** `neomundi-barometer-1-2026-w25`
**Observation period:** 2026-06-15 to 2026-06-21
...
Provider and model identifiers, prompts, response content, request IDs, trace IDs, raw payloads, per-response timestamps and debugging material are not included.
...
These figures must not be treated as independent confirmations. The purpose of the release is to expose this limitation rather than conceal it.
...
The public artefacts can be checked for internal consistency.

Full reproduction from source requests requires access to the private campaign exports under the NeoMundi Observatory governance process.
